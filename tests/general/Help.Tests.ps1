...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ucm-psmodule\functions", "$global:testroot\..\ucm-psmodule\internal\functions"),
	
	[string]
	$ModuleName = "ucm-psmodule",
...
$CommandPath = @(
    "$global:testroot\..\ucm-psmodule\functions"
    "$global:testroot\..\ucm-psmodule\internal\functions"
)
