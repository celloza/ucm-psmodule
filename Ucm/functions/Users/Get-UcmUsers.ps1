<#
.SYNOPSIS
    Lists all Users using the UCM API.

.DESCRIPTION
    This cmdlet corresponds to the API method "listUser" and performs operations related to
    Users.
...
.EXAMPLE
    # Example usage
    Get-UcmUsers -Uri http://10.10.10.1:80/api -Cookie "session_cookie" -Top 15 -Page 2 -SortOrder "desc"
#>
function Get-UcmUsers
{
    [CmdletBinding()]
    param (
        [Parameter(Mandatory)]
