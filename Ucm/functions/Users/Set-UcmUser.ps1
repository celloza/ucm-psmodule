...
.DESCRIPTION
    This cmdlet corresponds to the API method "updateUser" and performs operations related to User.
...
.EXAMPLE
    # Example usage
    Set-UcmUser -Uri http://10.10.10.1:80/api -Cookie "session_cookie"
#>
function Set-UcmUser
{
    ...
    {
        Write-Error "API call to updateUser failed. Status code was $((ConvertFrom-Json $apiResponse.Content).status)."
    }
    else
    {
