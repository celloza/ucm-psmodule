...
.DESCRIPTION
    This cmdlet corresponds to the API method "deleteSIPTrunk" and performs operations related to SipTrunk.
...
.EXAMPLE
    # Example usage
    Remove-UcmSipTrunk -Uri http://10.10.10.1:80/api -Cookie "session_cookie"
#>
